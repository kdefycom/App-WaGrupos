...
function setupFilters() {
    document.getElementById('whatsappFilter').addEventListener('click', () => filterByType('whatsapp', document.getElementById('whatsappFilter')));
    document.getElementById('telegramFilter').addEventListener('click', () => filterByType('telegram', document.getElementById('telegramFilter')));
    document.getElementById('canalWhatsappFilter').addEventListener('click', () => filterByType('canal_whatsapp', document.getElementById('canalWhatsappFilter')));
    document.getElementById('instagramFilter').addEventListener('click', () => filterByType('instagram', document.getElementById('instagramFilter')));
}
...
function filterByType(type, element) {
    ...
    const titulos = {
        ...
        canal_whatsapp: 'Canais de WhatsApp em Destaque',
        instagram: 'Grupos de Instagram em Destaque'
    };
    title.textContent = titulos[type] || 'Grupos em Destaque';
